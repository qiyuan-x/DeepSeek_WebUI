...
export default function App() {
  ...
  const { isStorySetupOpen, setStorySetupOpen, isPromptDialogOpen, setPromptDialogOpen, setSettingsOpen, isStoryDiscussionOpen, setStoryDiscussionOpen, isMemoryOpen, setMemoryOpen } = useUIStore();
